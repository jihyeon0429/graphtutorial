...
return v1.user_nm, v2.category1, r.event_type as event
    ...
    with col_2:    
        ...
        text="""ㅤㅤ단순하게 사용자와 아이템에 특정 행동을 했을 경우 row로는 확인하기 어렵습니다.\n
ㅤㅤ그래프 추천시스템은 관계를 통해 사용자와 아이템을 연결하여 유사 아이템을 구매한 서로 다른 유저 탐색이 용이하고 \n
ㅤㅤ사용자들에게 새로운 아이템을 추천합니다.\n
ㅤㅤ아래와 같이 multi depth의 graph path 조회를 통해 각 유저가 어떤 항목을 같이 구매했는지 확인할 수 있습니다."""
        st.write(text)
